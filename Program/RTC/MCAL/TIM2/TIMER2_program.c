...
#elif TIM2_WAVE == TIM2_SET_OC0
	SET_BIT(TCCR2,4);
	SET_BIT(TCCR2,5);

#elif TIM2_WAVE == TIM2_CLR_OC0
	CLR_BIT(TCCR2,4);
	SET_BIT(TCCR2,5);

#elif TIM2_WAVE == TIM2_FAST_INVERT_OC0
	SET_BIT(TCCR2,4);
	SET_BIT(TCCR2,5);
#elif TIM2_WAVE == TIM2_FAST_NONINVERT_OC0
	CLR_BIT(TCCR2,4);
	SET_BIT(TCCR2,5);

#elif TIM2_WAVE == TIM2_PHASE_NONINVERT_OC0
	CLR_BIT(TCCR2,4);
	SET_BIT(TCCR2,5);

#elif TIM2_WAVE == TIM2_PHASE_INVERT_OC0
	SET_BIT(TCCR2,4);
	SET_BIT(TCCR2,5);
